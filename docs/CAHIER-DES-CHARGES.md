...
- [ ] **Event Intelligence — PHASE 7** — SymbolNews + correlate → `EVENT_MARKET` ; Claude explainer ; promotion seuils après walk-forward. Doc : `docs/EVENT-INTELLIGENCE-LAYER-AUDIT.md`.
