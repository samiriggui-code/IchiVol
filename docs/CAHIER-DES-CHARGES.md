...
- [ ] **Event Intelligence — PHASE 6–7** — calibration seuils / event-study NORMAL vs EVENT ; SymbolNews + correlate ; `EVENT_MARKET` ; Claude explainer. Doc : `docs/EVENT-INTELLIGENCE-LAYER-AUDIT.md`.
