...
- [ ] **Event Intelligence — Anomaly Detector (PHASE 5+)** — observation quantitative causale (`app/events/`) exposée sur décisions **sans vote** pipeline ; seuils à calibrer (PHASE 6 event-study) ; news/earnings/correlate ensuite. Doc audit §phases 5–7.
