...
export function BacktestsPage() {
  ...
  const perimeter = useMemo(() => {
    ...
    return EXPERIMENTS[0][1] // structure label fallback only for table col — still show engine when known
  }, [coverage])
  ...
  return (
    <div className="lab-page">
      ...
      <div className="notice blue">
        ◈{' '}
        <span>
          Résultats engine · couverture backtest / runs persistés · aucun nouveau backtest lancé
          depuis ce front.
        </span>
      </div>
      ...
      <section className="card">
        <div className="card-head">
          <h2>{cardTitle}</h2>
          <button type="button" className="primary" disabled title="Non branché au moteur">
              ...
              {EXPERIMENTS.map((r, i) => {
                ...
                return (
                  <tr key={r[0]}>
                    ...
                    <td>{status}</td>
                    <td>
                      <button type="button" className="subtle" data-experiment={i}>
                        Examiner ↗
                      </button>
                    </td>
                  </tr>
