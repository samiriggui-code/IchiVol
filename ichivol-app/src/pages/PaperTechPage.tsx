...
/** Ancienne UI Paper (technique) — sources, % trades, evidence IDs. */
  ...
  return (
    <div className="paper-page">
      <header className="page-head">
        <h1>Paper technique</h1>
        <p className="muted">
          Vue debug : sources, métriques %, evidence IDs, ShadowBroker. Pour le compte en langage
          simple → <Link to="/app/paper">Paper</Link>.
        </p>
      </header>
