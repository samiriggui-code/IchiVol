    ...
    specs.extend(
        [
            ...
            ConditionSpec(
                ...
                "Bullish change of character (break against bearish bias).",
            ),
            ConditionSpec(
                "choch_bearish",
                bool,
                ...
                "Bearish change of character (break against bullish bias).",
            ),
            ConditionSpec(
                "break_quality",
                str,
                ...
                "Structure break quality: wick | close | confirmed.",
