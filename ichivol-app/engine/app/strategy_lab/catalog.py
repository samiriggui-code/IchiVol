...
_BUILTIN_RAW: list[dict] = [
    ...
    {
        "id": "IV_EXP_PPO_ICHI_RVOL_001",
        "version": "1",
        "direction": "LONG",
        "description": "T-EXP — Ichimoku + RVOL + PPO STRONG_BULLISH (shadow / ablation only)",
        "conditions": {
            "price_above_kumo": True,
            "tenkan_above_kijun": True,
            "tk_cross_age_max": 3,
    ...
    {
        "id": "IV_EXP_BESTCLOUD_ICHI_RVOL_001",
        "version": "1",
        "direction": "LONG",
        "description": "T-EXP — Ichimoku + RVOL + BEST Cloud BULLISH (redundancy test vs Ichimoku)",
        "conditions": {
            "price_above_kumo": True,
            "tenkan_above_kijun": True,
            "tk_cross_age_max": 3,
    ...
    {
        "id": "IV_EXP_PPO_BESTCLOUD_ICHI_RVOL_BOS_001",
        "version": "1",
        "direction": "LONG",
        "description": "T-EXP — Ichimoku + RVOL + BOS + PPO + BEST Cloud (full ladder, ablation only)",
        "conditions": {
            "price_above_kumo": True,
            "tenkan_above_kijun": True,
            "tk_cross_age_max": 3,
