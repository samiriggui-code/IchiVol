...
class LedgerTransaction(Base):
    ...
    __table_args__ = (UniqueConstraint("portfolio_id", "key", name="uq_ledger_portfolio_key"),)
    ...
    legs: Mapped[list["LedgerLeg"]] = relationship(
        back_populates="transaction", order_by="LedgerLeg.seq"
    )


class LedgerLeg(Base):
    __tablename__ = "ledger_legs"
    __table_args__ = (UniqueConstraint("transaction_id", "seq", name="uq_ledger_leg_tx_seq"),)
    ...
    transaction: Mapped[LedgerTransaction] = relationship(back_populates="legs")
