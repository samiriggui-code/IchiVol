    ...
    for spec in (
        ...
        ToolSpec(
            ...
            True,
            {
                ...
                "timeframe": "str, défaut '1h'",
                "limit": "int, défaut 300",
                "sources": "str CSV ou list, défaut 'engine,user,claude'",
                "include_pytrendline": "bool, défaut false",
            },
            cmd_get_chart_objects,
        ),
        ToolSpec(
            ...
            False,
            {
                ...
                "source": "str, défaut 'claude' (user|claude)",
                "label": "str, optionnel",
                "side": "str, optionnel",
            },
            cmd_draw_horizontal_line,
        ...
        ToolSpec(
            ...
            False,
            {
                "id": "str, requis — ChartObject.id",
                "source": "str, optionnel — filtre user|claude",
            },
            cmd_delete_chart_object,
        ),
    )
